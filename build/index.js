...
var Button = react.forwardRef(function (props, innerRef) {
    ...
    return (jsxRuntime.jsxs(Tag, __assign({ ref: mergedRefs, href: href, title: title, role: role, id: id, type: type, className: classes, onClick: handleClick, onMouseEnter: handleMouseEnter, onMouseLeave: onMouseLeave, onMouseDown: onMouseDown, onMouseUp: onMouseUp, onBlur: onBlur, onFocus: onFocus }, { children: [!loading && addonLeft && (jsxRuntime.jsx("span", __assign({ className: "z-10 mx-1 mr-2" }, { children: addonLeft }), void 0)), !loading && (jsxRuntime.jsx("span", __assign({ className: "z-10" }, { children: children }), void 0)), !loading && addonRight && (jsxRuntime.jsx("span", __assign({ className: "z-10 mx-1 ml-2" }, { children: addonRight }), void 0))] }), void 0));
});
